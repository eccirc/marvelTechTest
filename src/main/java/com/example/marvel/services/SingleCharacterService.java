...
public class SingleCharacterService {
    ...
    public MarvelCharacter getSingleCharacterFromAPI(Integer characterID){
    ...
    public MarvelCharacter MarvelCharacterTranslated(Integer characterID, String langCode){
